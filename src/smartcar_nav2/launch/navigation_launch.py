...
def generate_launch_description():
    ...
    declare_container_name_cmd = DeclareLaunchArgument(
        ...
        description='Name of the Nav2 component container',
    )
    ...
    launch_description.add_action(declare_use_composition_cmd)
    launch_description.add_action(declare_container_name_cmd)
    ...
    launch_description.add_action(load_composable_nodes)
