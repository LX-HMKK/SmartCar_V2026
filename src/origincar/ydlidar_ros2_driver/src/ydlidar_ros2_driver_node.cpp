...
int main(int argc, char *argv[]) {
  ...
  // 核心修改点：将 rclcpp::SensorDataQoS() 更改为 rclcpp::SystemDefaultsQoS()
  // 这样可以兼容大部分默认使用 Reliable 策略的接收端（如 slam_toolbox）
