...
from launch_ros.actions import Node  # Humble 修复：由 LifecycleNode 改为标准 Node 避免冲突
...
def generate_launch_description():
    ...
    # 静态 TF 坐标变换发布器
    # 作用：将雷达安装位置 (laser_frame) 固定绑定到小车中心 (base_link) 上
    # Humble 修复：将 node_executable 改为 executable，将 node_name 改为 name
  #  tf2_node = Node(
 #       package='tf2_ros',
