...
class SafetyGuard {
public:
  SafetyGuard(double cmd_timeout, double odom_timeout,
...
private:
  double cmd_timeout_, odom_timeout_, raw_odom_timeout_,
      depth_points_timeout_, min_voltage_, voltage_timeout_,
      max_linear_speed_mps_;
  bool require_odom_, require_raw_odom_, require_depth_points_;
  double cmd_at_, odom_at_, raw_odom_at_, depth_points_at_, voltage_at_;
  float voltage_;
  bool cmd_invalid_, cmd_speed_limit_exceeded_, estop_;
  bool cmd_at_set_, odom_at_set_, raw_odom_at_set_, depth_points_at_set_,
      voltage_at_set_;
